...
public interface game_service extends Serializable{
    ...
    public String move();
    /**
     * Performs a login - so the results of the game will be stored in the gameClient.data-base after the game,
     * requires Internet connection. The following gameClient.data is stored: id, level, number of moves, grade & time.
     * @param id
