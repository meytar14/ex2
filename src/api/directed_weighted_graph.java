...
public interface directed_weighted_graph {
    ...
    /**
     * returns the gameClient.data of the edge (src,dest), null if none.
     ...
     * @return the gameClient.data of the removed node (null if none).
     * @param key
     */
     ...
     * @param src
     * @param dest
     * @return the gameClient.data of the removed edge (null if none).
     */
